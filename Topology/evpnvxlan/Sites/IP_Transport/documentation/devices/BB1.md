...
| 172.16.2.1 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 172.16.2.3 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65000
   ...
   neighbor 172.16.1.1 remote-as 65178
   neighbor 172.16.1.1 description A-LEAF7
   ...
   neighbor 172.16.2.1 description B-LEAF7
   neighbor 172.16.2.3 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.2.3 remote-as 65200
   neighbor 172.16.2.3 description B-LEAF8
