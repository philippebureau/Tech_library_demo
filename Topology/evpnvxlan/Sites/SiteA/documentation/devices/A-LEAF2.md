...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | default | 172.100.100.106/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| A-LEAF12 | Vlan4094 | 169.254.0.0 | Port-Channel1000 |
...
mlag configuration
   ...
   peer-address heartbeat 172.100.100.105
...
| Ethernet7 | HostA_NIC2 | *access | *10 | *- | *- | 7 |
| Ethernet8 | HostB_NIC2 | *access | *30 | *- | *- | 8 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_A-SPINE1_Ethernet2 | routed | - | 192.168.0.9/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_A-SPINE2_Ethernet2 | routed | - | 192.168.0.11/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_A-SPINE3_Ethernet2 | routed | - | 192.168.0.13/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_A-SPINE4_Ethernet2 | routed | - | 192.168.0.15/31 | default | 1500 | False | - | - |
...
!
interface Ethernet7
   description HostA_NIC2
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description HostB_NIC2
   no shutdown
...
| 192.168.0.8 | 65100 | default | - | Inherited from peer group LOCAL-IPV4-PEERS | Inherited from peer group LOCAL-IPV4-PEERS | - | - | - | - | - |
| 192.168.0.10 | 65100 | default | - | Inherited from peer group LOCAL-IPV4-PEERS | Inherited from peer group LOCAL-IPV4-PEERS | - | - | - | - | - |
| 192.168.0.12 | 65100 | default | - | Inherited from peer group LOCAL-IPV4-PEERS | Inherited from peer group LOCAL-IPV4-PEERS | - | - | - | - | - |
| 192.168.0.14 | 65100 | default | - | Inherited from peer group LOCAL-IPV4-PEERS | Inherited from peer group LOCAL-IPV4-PEERS | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.0.0.12:10010 | 10010:10010 | - | - | learned |
| 30 | 10.0.0.12:10030 | 10030:10030 | - | - | learned |
...
router bgp 65112
   ...
   neighbor MLAG-IPV4-PEER description A-LEAF1
   ...
   neighbor 192.168.0.8 remote-as 65100
   neighbor 192.168.0.8 description A-SPINE1_Ethernet2
   neighbor 192.168.0.10 peer group LOCAL-IPV4-PEERS
   neighbor 192.168.0.10 remote-as 65100
   neighbor 192.168.0.10 description A-SPINE2_Ethernet2
   neighbor 192.168.0.12 peer group LOCAL-IPV4-PEERS
   neighbor 192.168.0.12 remote-as 65100
   neighbor 192.168.0.12 description A-SPINE3_Ethernet2
   neighbor 192.168.0.14 peer group LOCAL-IPV4-PEERS
   neighbor 192.168.0.14 remote-as 65100
   neighbor 192.168.0.14 description A-SPINE4_Ethernet2
