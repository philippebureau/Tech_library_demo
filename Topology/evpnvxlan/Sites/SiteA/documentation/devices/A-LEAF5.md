...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 172.100.100.109/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| A-LEAF56 | Vlan4094 | 169.254.0.1 | Port-Channel5 |
...
mlag configuration
   ...
   peer-address heartbeat 172.100.100.110 vrf MGMT
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_PEER_A-LEAF6_Ethernet5 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 5 |
| Ethernet6 | MLAG_PEER_A-LEAF6_Ethernet6 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_A-SPINE1_Ethernet5 | routed | - | 192.168.0.33/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_A-SPINE2_Ethernet5 | routed | - | 192.168.0.35/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LINK_TO_A-SPINE3_Ethernet5 | routed | - | 192.168.0.37/31 | default | 9214 | False | - | - |
| Ethernet4 | P2P_LINK_TO_A-SPINE4_Ethernet5 | routed | - | 192.168.0.39/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_A-SPINE1_Ethernet5
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_A-SPINE2_Ethernet5
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet3
   description P2P_LINK_TO_A-SPINE3_Ethernet5
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet4
   description P2P_LINK_TO_A-SPINE4_Ethernet5
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet5
   description MLAG_PEER_A-LEAF6_Ethernet5
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | MLAG_PEER_A-LEAF6_Po5 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel5
   description MLAG_PEER_A-LEAF6_Po5
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.0.0.15/32 |
...
| 192.168.0.32 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.34 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.36 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.38 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.0.0.15:10010 | 10010:10010 | - | - | learned |
| 30 | 10.0.0.15:10030 | 10030:10030 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| PROD | 10.0.0.15:50001 | connected |
...
router bgp 65156
   ...
   neighbor 192.0.0.1 description A-LEAF6
   neighbor 192.168.0.32 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.32 remote-as 65100
   neighbor 192.168.0.32 description A-SPINE1_Ethernet5
   neighbor 192.168.0.34 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.34 remote-as 65100
   neighbor 192.168.0.34 description A-SPINE2_Ethernet5
   neighbor 192.168.0.36 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.36 remote-as 65100
   neighbor 192.168.0.36 description A-SPINE3_Ethernet5
   neighbor 192.168.0.38 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.38 remote-as 65100
   neighbor 192.168.0.38 description A-SPINE4_Ethernet5
