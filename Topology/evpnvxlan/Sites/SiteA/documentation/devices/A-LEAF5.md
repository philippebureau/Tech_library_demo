...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | default | 172.100.100.109/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| A-LEAF56 | Vlan4094 | 169.254.0.1 | Port-Channel1000 |
...
mlag configuration
   ...
   peer-address heartbeat 172.100.100.110
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_A-SPINE1_Ethernet5 | routed | - | 192.168.0.33/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_A-SPINE2_Ethernet5 | routed | - | 192.168.0.35/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_A-SPINE3_Ethernet5 | routed | - | 192.168.0.37/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_A-SPINE4_Ethernet5 | routed | - | 192.168.0.39/31 | default | 1500 | False | - | - |
...
| 192.168.0.32 | 65100 | default | - | Inherited from peer group LOCAL-IPV4-PEERS | Inherited from peer group LOCAL-IPV4-PEERS | - | - | - | - | - |
| 192.168.0.34 | 65100 | default | - | Inherited from peer group LOCAL-IPV4-PEERS | Inherited from peer group LOCAL-IPV4-PEERS | - | - | - | - | - |
| 192.168.0.36 | 65100 | default | - | Inherited from peer group LOCAL-IPV4-PEERS | Inherited from peer group LOCAL-IPV4-PEERS | - | - | - | - | - |
| 192.168.0.38 | 65100 | default | - | Inherited from peer group LOCAL-IPV4-PEERS | Inherited from peer group LOCAL-IPV4-PEERS | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 70 | 10.0.0.15:10070 | 10070:10070 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| DEV | 10.0.0.15:50002 | connected |
...
router bgp 65156
   ...
   neighbor MLAG-IPV4-PEER description A-LEAF6
   ...
   neighbor 192.168.0.34 peer group LOCAL-IPV4-PEERS
   neighbor 192.168.0.34 remote-as 65100
   neighbor 192.168.0.34 description A-SPINE2_Ethernet5
   neighbor 192.168.0.36 peer group LOCAL-IPV4-PEERS
