...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | default | 172.100.100.119/24 | - |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_B-SPINE1_Ethernet2 | routed | - | 9.9.9.9/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_B-SPINE2_Ethernet2 | routed | - | 9.9.9.11/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_B-SPINE3_Ethernet2 | routed | - | 9.9.9.13/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_B-SPINE4_Ethernet2 | routed | - | 9.9.9.15/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.0.0.22/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.2.2.22/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 9.9.9.8 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 9.9.9.10 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 9.9.9.12 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 9.9.9.14 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 20 | 10.0.0.22:10020 | 10020:10020 | - | - | learned |
| 40 | 10.0.0.22:10040 | 10040:10040 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| PROD | 10.0.0.22:50001 | connected |
...
router bgp 65200
   ...
   neighbor 9.9.9.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 9.9.9.8 remote-as 65200
   neighbor 9.9.9.8 description B-SPINE1_Ethernet2
   neighbor 9.9.9.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 9.9.9.10 remote-as 65200
   neighbor 9.9.9.10 description B-SPINE2_Ethernet2
   neighbor 9.9.9.12 peer group IPv4-UNDERLAY-PEERS
   neighbor 9.9.9.12 remote-as 65200
   neighbor 9.9.9.12 description B-SPINE3_Ethernet2
   neighbor 9.9.9.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 9.9.9.14 remote-as 65200
   neighbor 9.9.9.14 description B-SPINE4_Ethernet2
