...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_B-SPINE1_Ethernet4 | routed | - | 9.9.9.25/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_B-SPINE2_Ethernet4 | routed | - | 9.9.9.27/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_B-SPINE3_Ethernet4 | routed | - | 9.9.9.29/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_B-SPINE4_Ethernet4 | routed | - | 9.9.9.31/31 | default | 1500 | False | - | - |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 9.9.9.24 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 9.9.9.26 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 9.9.9.28 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 9.9.9.30 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65200
   ...
   neighbor 9.9.9.24 peer group IPv4-UNDERLAY-PEERS
   neighbor 9.9.9.24 remote-as 65200
   neighbor 9.9.9.24 description B-SPINE1_Ethernet4
   neighbor 9.9.9.26 peer group IPv4-UNDERLAY-PEERS
   neighbor 9.9.9.26 remote-as 65200
   neighbor 9.9.9.26 description B-SPINE2_Ethernet4
   neighbor 9.9.9.28 peer group IPv4-UNDERLAY-PEERS
   neighbor 9.9.9.28 remote-as 65200
   neighbor 9.9.9.28 description B-SPINE3_Ethernet4
   neighbor 9.9.9.30 peer group IPv4-UNDERLAY-PEERS
   neighbor 9.9.9.30 remote-as 65200
   neighbor 9.9.9.30 description B-SPINE4_Ethernet4
