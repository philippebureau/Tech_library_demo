...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | default | 172.100.100.123/24 | - |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_B-SPINE1_Ethernet6 | routed | - | 9.9.9.41/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_B-SPINE2_Ethernet6 | routed | - | 9.9.9.43/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_B-SPINE3_Ethernet6 | routed | - | 9.9.9.45/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_B-SPINE4_Ethernet6 | routed | - | 9.9.9.47/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.0.0.26/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.2.2.26/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 9.9.9.40 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 9.9.9.42 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 9.9.9.44 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 9.9.9.46 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65200
   ...
   neighbor 9.9.9.40 peer group IPv4-UNDERLAY-PEERS
   neighbor 9.9.9.40 remote-as 65200
   neighbor 9.9.9.40 description B-SPINE1_Ethernet6
   neighbor 9.9.9.42 peer group IPv4-UNDERLAY-PEERS
   neighbor 9.9.9.42 remote-as 65200
   neighbor 9.9.9.42 description B-SPINE2_Ethernet6
   neighbor 9.9.9.44 peer group IPv4-UNDERLAY-PEERS
   neighbor 9.9.9.44 remote-as 65200
   neighbor 9.9.9.44 description B-SPINE3_Ethernet6
   neighbor 9.9.9.46 peer group IPv4-UNDERLAY-PEERS
   neighbor 9.9.9.46 remote-as 65200
   neighbor 9.9.9.46 description B-SPINE4_Ethernet6
