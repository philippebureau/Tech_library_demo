...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | default | 172.100.100.130/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| C-LEAF12 | Vlan4094 | 169.254.0.0 | Port-Channel1000 |
...
mlag configuration
   ...
   peer-address heartbeat 172.100.100.129
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_PEER_C-LEAF1_Ethernet5 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
| Ethernet6 | MLAG_PEER_C-LEAF1_Ethernet6 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
| Ethernet7 | HostN_NIC2 | *access | *10 | *- | *- | 7 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_C-SPINE1_Ethernet2 | routed | - | 192.168.0.5/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_C-SPINE2_Ethernet2 | routed | - | 192.168.0.7/31 | default | 1500 | False | - | - |
...
| Port-Channel1000 | MLAG_PEER_C-LEAF1_Po1000 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.0.0.32/32 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 10.0.0.32 | enabled | Ethernet1 <br> Ethernet2 <br> Vlan4093 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.0.0.32:10010 | 10010:10010 | - | - | learned |
| 30 | 10.0.0.32:10030 | 10030:10030 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| PROD | 10.0.0.32:50001 | connected |
...
router bgp 65312
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description C-LEAF1
