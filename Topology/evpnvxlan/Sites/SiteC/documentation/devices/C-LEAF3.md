...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | default | 172.100.100.131/24 | - |
...
mlag configuration
   ...
   peer-address heartbeat 172.100.100.132
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_PEER_C-LEAF4_Ethernet5 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
| Ethernet6 | MLAG_PEER_C-LEAF4_Ethernet6 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
| Ethernet7 |  HostO_NIC1 | access | 20 | - | - | - |
| Ethernet8 | HostP_NIC1 | *access | *60 | *- | *- | 8 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_C-SPINE1_Ethernet3 | routed | - | 192.168.0.9/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_C-SPINE2_Ethernet3 | routed | - | 192.168.0.11/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_C-SPINE1_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_C-SPINE2_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet5
   description MLAG_PEER_C-LEAF4_Ethernet5
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet6
   description MLAG_PEER_C-LEAF4_Ethernet6
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet7
   description HostO_NIC1
   no shutdown
...
| Port-Channel1000 | MLAG_PEER_C-LEAF4_Po1000 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1000
   description MLAG_PEER_C-LEAF4_Po1000
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.0.0.33/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.3.3.33/32 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 10.0.0.33 | enabled | Ethernet1 <br> Ethernet2 <br> Vlan4093 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
...
| --- | ------------------- | ------------ |
| DEV | 10.0.0.33:50002 | connected |
| PROD | 10.0.0.33:50001 | connected |
...
router bgp 65334
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER remote-as 65334
   neighbor MLAG-IPv4-UNDERLAY-PEER next-hop-self
   neighbor MLAG-IPv4-UNDERLAY-PEER description C-LEAF4
