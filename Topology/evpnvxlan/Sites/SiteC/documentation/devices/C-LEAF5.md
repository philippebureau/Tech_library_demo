...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | default | 172.100.100.133/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| C-LEAF56 | Vlan4094 | 169.254.0.1 | Port-Channel1000 |
...
mlag configuration
   ...
   peer-address heartbeat 172.100.100.134
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_PEER_C-LEAF6_Ethernet5 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
| Ethernet6 | MLAG_PEER_C-LEAF6_Ethernet6 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
| Ethernet7 | HostR_NIC1 | *access | *20 | *- | *- | 7 |
| Ethernet8 | HostS_NIC1 | *access | *60 | *- | *- | 8 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_C-SPINE1_Ethernet5 | routed | - | 192.168.0.17/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_C-SPINE2_Ethernet5 | routed | - | 192.168.0.19/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_C-SPINE1_Ethernet5
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_C-SPINE2_Ethernet5
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet5
   description MLAG_PEER_C-LEAF6_Ethernet5
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet6
   description MLAG_PEER_C-LEAF6_Ethernet6
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet7
   description HostR_NIC1
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description HostS_NIC1
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel7 | HostR | switched | access | 20 | - | - | - | - | 7 | - |
| Port-Channel8 | HostS | switched | access | 60 | - | - | - | - | 8 | - |
| Port-Channel1000 | MLAG_PEER_C-LEAF6_Po1000 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1000
   description MLAG_PEER_C-LEAF6_Po1000
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.0.0.35/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.3.3.35/32 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 10.0.0.35 | enabled | Ethernet1 <br> Ethernet2 <br> Vlan4093 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 20 | 10.0.0.35:10020 | 10020:10020 | - | - | learned |
| 60 | 10.0.0.35:10060 | 10060:10060 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| DEV | 10.0.0.35:50002 | connected |
| PROD | 10.0.0.35:50001 | connected |
...
router bgp 65356
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER remote-as 65356
   neighbor MLAG-IPv4-UNDERLAY-PEER next-hop-self
   neighbor MLAG-IPv4-UNDERLAY-PEER description C-LEAF6
