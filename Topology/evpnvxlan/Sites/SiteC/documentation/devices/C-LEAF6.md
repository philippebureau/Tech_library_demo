...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | default | 172.100.100.134/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| C-LEAF56 | Vlan4094 | 169.254.0.0 | Port-Channel1000 |
...
mlag configuration
   ...
   peer-address heartbeat 172.100.100.133
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_PEER_C-LEAF5_Ethernet5 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
| Ethernet6 | MLAG_PEER_C-LEAF5_Ethernet6 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
| Ethernet7 | HostR_NIC2 | *access | *20 | *- | *- | 7 |
| Ethernet8 | HostS_NIC2 | *access | *60 | *- | *- | 8 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_C-SPINE1_Ethernet6 | routed | - | 192.168.0.21/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_C-SPINE2_Ethernet6 | routed | - | 192.168.0.23/31 | default | 1500 | False | - | - |
...
| Port-Channel1000 | MLAG_PEER_C-LEAF5_Po1000 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.0.0.36/32 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 10.0.0.36 | enabled | Ethernet1 <br> Ethernet2 <br> Vlan4093 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 20 | 10.0.0.36:10020 | 10020:10020 | - | - | learned |
| 60 | 10.0.0.36:10060 | 10060:10060 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| DEV | 10.0.0.36:50002 | connected |
| PROD | 10.0.0.36:50001 | connected |
...
router bgp 65356
   ...
   neighbor MLAG-IPV4-PEER remote-as 65356
   neighbor MLAG-IPV4-PEER next-hop-self
   neighbor MLAG-IPV4-PEER description C-LEAF5
