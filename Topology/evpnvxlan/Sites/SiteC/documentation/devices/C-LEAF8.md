...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | default | 172.100.100.136/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| C-LEAF78 | Vlan4094 | 169.254.0.0 | Port-Channel1000 |
...
mlag configuration
   ...
   peer-address heartbeat 172.100.100.135
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_PEER_C-LEAF7_Ethernet5 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
| Ethernet6 | MLAG_PEER_C-LEAF7_Ethernet6 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_C-SPINE1_Ethernet8 | routed | - | 192.168.0.29/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_C-SPINE2_Ethernet8 | routed | - | 192.168.0.31/31 | default | 1500 | False | - | - |
| Ethernet7 | P2P_LINK_TO_BB1_Ethernet6 | routed | - | 172.16.3.3/31 | default | 1500 | False | - | - |
| Ethernet8 | P2P_LINK_TO_BB2_Ethernet6 | routed | - | 172.16.3.7/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1000 | MLAG_PEER_C-LEAF7_Po1000 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.0.0.38/32 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 10.0.0.38 | enabled | Ethernet1 <br> Ethernet2 <br> Vlan4093 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
...
| 172.16.3.2 | Inherited from peer group REMOTE-IPV4-PEERS | default | - | - | - | - | - | - | - | - |
| 172.16.3.6 | Inherited from peer group REMOTE-IPV4-PEERS | default | - | - | - | - | - | - | - | - |
| 192.0.0.0 | Inherited from peer group MLAG-IPV4-PEER | DEV | - | Inherited from peer group MLAG-IPV4-PEER | Inherited from peer group MLAG-IPV4-PEER | - | - | - | - | - |
| 192.0.0.0 | Inherited from peer group MLAG-IPV4-PEER | PROD | - | Inherited from peer group MLAG-IPV4-PEER | Inherited from peer group MLAG-IPV4-PEER | - | - | - | - | - |
...
| 20 | 10.0.0.38:10020 | 10020:10020<br>remote 10020:10020 | - | - | learned |
...
| --- | ------------------- | ------------ |
| DEV | 10.0.0.38:50002 | connected |
| PROD | 10.0.0.38:50001 | connected |
...
router bgp 65378
   ...
   neighbor MLAG-IPV4-PEER description C-LEAF7
   ...
   neighbor 172.16.3.2 peer group REMOTE-IPV4-PEERS
   neighbor 172.16.3.6 peer group REMOTE-IPV4-PEERS
   !
   vlan 10
      rd 10.0.0.38:10010
      rd evpn domain remote 10.0.0.38:10010
   ...
   vlan 20
      rd 10.0.0.38:10020
      rd evpn domain remote 10.0.0.38:10020
   ...
   vlan 50
      rd 10.0.0.38:10050
      rd evpn domain remote 10.0.0.38:10050
